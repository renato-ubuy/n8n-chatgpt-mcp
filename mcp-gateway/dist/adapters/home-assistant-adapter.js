...
exports.HomeAssistantAdapter = void 0;
        ...
        try {
            ...
            switch (name) {
                ...
                case 'get_entities':
                    ...
                    if (args.domain) {
                        entities = entities.filter((entity) => entity.entity_id.startsWith(args.domain + '.'));
                    }
                ...
                case 'trigger_automation':
                    const triggerResponse = await this.client.post(`/api/services/automation/trigger`, { entity_id: args.entity_id });
                    return triggerResponse.data;
                case 'set_state':
                    const setStateResponse = await this.client.post(`/api/states/${args.entity_id}`, {
                        state: args.state,
...
exports.HomeAssistantAdapter = HomeAssistantAdapter;
//# sourceMappingURL=home-assistant-adapter.js.map