...
class WorkflowEngine extends events_1.EventEmitter {
    ...
    // Workflow Execution
    async executeWorkflow(workflowId, input, gatewayToken) {
    ...
    async executeWorkflowNodes(workflow, execution, gatewayToken) {
    ...
    async executeNode(node, previousResults, gatewayToken) {
        // Get the backend
