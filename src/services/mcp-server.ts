    ...
    const legacyTools: McpTool[] = [
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            id: { type: 'string', description: 'Workflow ID' },
            data: { type: 'object', description: 'Input data for workflow execution', additionalProperties: true },
          },
          required: ['id'],
        },
      },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            connections: { type: 'object', description: 'Node connections', additionalProperties: true },
            settings: { type: 'object', description: 'Workflow settings', additionalProperties: true },
            tags: { type: 'array', items: { type: 'string' }, description: 'Workflow tags' },
          },
          required: ['id'],
        },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            headers: { type: 'object', description: 'Additional request headers', additionalProperties: true },
            data: { type: 'object', description: 'Payload for webhook requests', additionalProperties: true },
